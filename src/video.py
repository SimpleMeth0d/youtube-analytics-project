...
class Video:
    ...
    def __init__(self, video_id: str):
        ...
        self.view_count = self.to_int(self.get_video_info()['items'][0]['statistics']['viewCount'])
        self.like_count = self.to_int(self.get_video_info()['items'][0]['statistics']['likeCount'])
